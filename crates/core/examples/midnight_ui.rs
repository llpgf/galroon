//! Isolated UI verification harness; writes a private, temporary session file under test-output.
#[tokio::main]async fn main(){
    ...
    std::fs::write("test-output/figma-implementation/session.json",session.to_string()).unwrap();
