...
import { ViewModeSelector, ViewingDistanceSlider, ViewMode } from '../components/DisplayGrammarControls';
...
export function GalleryPage({ heroSlides, items, onItemClick }: GalleryPageProps) {
