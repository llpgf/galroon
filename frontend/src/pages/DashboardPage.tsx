...
export function DashboardPage({ onNavigateToGallery }: DashboardPageProps) {
            ...
            <div className="relative w-full h-full overflow-hidden bg-[#0a0a0a] flex flex-col">
                  ...
                  <div className="relative" style={{ height: '40vh', minHeight: '300px' }}>
                        ...
                        <div className="absolute inset-0">
                              <Suspense fallback={<div className="w-full h-full bg-black/30" />}>
                                    <DiscoveryLens
                              ...
                              <div className="pointer-events-auto w-full max-w-lg px-8">
                                    <div className="relative group">
                                          ...
                                          <input
                                                ...
                                                className="w-full bg-black/40 backdrop-blur-xl border border-medium rounded-2xl pl-14 pr-12 py-4 text-white text-lg placeholder:text-white/30 focus:outline-none focus:border-strong focus:bg-black/60 transition-all shadow-2xl shadow-black/50"
                                          />
                                          {searchQuery && (
                                                <button
                  ...
                  <div className="flex-1 overflow-y-auto">
                        ...
                        {/* Stats Charts Grid */}
                        <Suspense fallback={<div className="px-8 py-6 text-white/40 text-sm">Loading charts…</div>}>
                              <StatsCharts />
                        </Suspense>
