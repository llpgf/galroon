...
interface CanonicalDetailViewEnhancedProps {
  game: CanonicalGame;
  onBack: () => void;
...
export function CanonicalDetailViewEnhanced({ 
  game, 
  onBack, 
  onLaunchGame, 
  onOpenFolder,
  onEditMetadata 
}: CanonicalDetailViewEnhancedProps) {
                        ...
                        >
                          ...
                          <div className="flex-1 flex flex-col">
                            ...
                            <div className="mt-auto">
                              <button
                                onClick={() => handleVoiceActorClick(character.voiceActor.id, character.voiceActor.name)}
                                className="flex items-center gap-2 text-[#9ca3af] hover:text-white transition-colors group"
                              >
                                <Mic className="w-4 h-4" strokeWidth={1.5} />
                                <span className="text-sm">CV: {character.voiceActor.name}</span>
                              </button>
                            </div>
                          </div>
                        </div>
